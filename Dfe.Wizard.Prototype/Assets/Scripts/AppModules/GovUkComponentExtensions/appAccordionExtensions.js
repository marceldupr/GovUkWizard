...
const accordionExtensions = function(){
  ...
  accordions.each(function(n, accordion) {
    ...
    const $scrollBtn = $(footerControls).prepend('<button class="asp-scroll-to-top">Back to top</button>');
...
export default accordionExtensions;
